...
public class GameFieldPanel extends JPanel {
	...
	// groesse von einem Teil des Feldes
	private int gridsize;
	// gesamt groesse des Feldes in pix
	...
	// Vareablen fuer die Selectionsfunction
	...
	// kuemmert sich um die Animation
	...
	// wir fuer den Wasserhintergrund verwendet
	private JBSActor water = new JBSActor();
	
	/**
	 * 
	 * @param fild spielfeld
	 * @param fieldsize	groesse des Spielfeldes z.B. 16*16
	 * @param size groesse des gesammten Spielfeldes in Pix
	 */
	public GameFieldPanel(JBSGameField fild ,int fieldsize ,int size) {
		...
		// uebergibt die groesse fuer ein Feld von dem Spielfeld um die Bilder anzupassen
		...
		// ermoeglich das Selectiren einzelner Felder
		...
		// ermoeglicht das hovern auf einzelnen Feldern
